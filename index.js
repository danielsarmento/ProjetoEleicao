...
app.get('/', async (req, res) => {
    ...
    res.json({
        ...
        SecoesTotalizadasPB: dataGov.pst + '%',
        AbstencaoPB: dataGov.pa + '%',
        Joao: dataGov.cand[0].pvap +'%',
        Votos1PB: dataGov.cand[0].vap,
        Pedro: dataGov.cand[1].pvap +'%',
        Votos2PB: dataGov.cand[1].vap
